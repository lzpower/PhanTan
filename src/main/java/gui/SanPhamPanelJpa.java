...
public class SanPhamPanelJpa extends JPanel {
    ...
    private JPanel createFormPanel() {
        ...
        panel.add(label("Gia nhap:"), gc(row++));
        txtGiaNhap = new JTextField();
        panel.add(txtGiaNhap, gc(row++));
    ...
    private JPanel createTablePanel() {
        ...
        model = new DefaultTableModel(new Object[]{"STT", "Hinh anh", "Ma", "Ten", "Loai", "So luong", "Gia nhap", "Gia ban", "Thao tac"}, 0) {
            @Override
        ...
        // Render image preview inside the table's image column
        table.getColumnModel().getColumn(1).setCellRenderer(new ImageTableCellRenderer());

        TableUtility.addActionColumn(table, 8, "/icon/sua.png", "/icon/xoa.png", new TableUtility.ActionButtonCallback() {
            @Override
    ...
    private SanPhamDto collectForm() {
        ...
        dto.setGiaNhap(Double.parseDouble(txtGiaNhap.getText().trim()));
