...
public class Gui_TaiKhoan extends JPanel {
    ...
    private final TaiKhoanService service = ServiceFactory.get(TaiKhoanService.class, TaiKhoanServiceImpl::new);

    private JTextField txtSearch;
    private JTextField txtTenDangNhap;
    private JPasswordField txtMatKhau;
    private JComboBox<ChucVuDto> cboVaiTro;
    private final ChucVuService roleService = ServiceFactory.get(ChucVuService.class, ChucVuServiceImpl::new);
    ...
    private void chonTaiKhoan(int row) {
        ...
        // chọn vai trò trong combobox theo tên hiển thị hoặc id
